...
namespace HabitosApp.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUsersService usersService, IConverterHelper converterHelper, DataContext context)
        {
        ...
        {
            IEnumerable<User> users = await _context.Users.Include(u => u.HabitosAppRole).ToListAsync();
            return View(users);
        }
